...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A flexible input component that supports various types, validation states, and accessibility features.",
      },
    },
  },
  argTypes: {
...
// Example of functional icon usage - password visibility toggle
