...
export const LongQuote = {
  render: () => (
    <Quote cite="– Nelson Mandela" color="orange" style={{ maxWidth: "600px" }}>
      There is no passion to be found playing small – in settling for a life
      that is less than the one you are capable of living. Your playing small
...
export const NoAttribution = {
  args: {
    children:
      "Some quotes don&apos;t need attribution and can stand on their own.",
    color: "pink",
  },
};
  ...
  render: () => (
    <article style={{ maxWidth: "800px" }}>
      ...
      <p style={{ marginBottom: "1.5rem", lineHeight: 1.6 }}>
        ...
        functional and delightful. As one of the most influential designers of
        our time once said:
      </p>
      <Quote cite="– Dieter Rams" color="blue" style={{ margin: "2rem 0" }}>
  ...
  render: () => (
    <div style={{ maxWidth: "700px" }}>
      ...
      <p style={{ marginBottom: "1rem" }}>
        When asked about the future of artificial intelligence, the CEO
        responded:
      </p>
      <Quote
        ...
        icon={<IconQuote />}
      >
        AI is not about replacing human creativity, but about augmenting it. The
        most successful implementations will be those that enhance human
        capabilities rather than trying to replicate them entirely.
      </Quote>
      <p style={{ marginTop: "1rem" }}>
        This perspective highlights the collaborative potential between humans
        and AI systems.
      </p>
    </div>
  ),
