  ...
  education: [
    {
      ...
      endDate: "2025",
      visibility: { online: true, print: true },
      courses: ["Capstone Projects: AI Clinical Trial Matching"],
      relevantCoursework: [
...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A comprehensive resume component that displays professional information in a print-optimized format. Supports filtering by specific companies and print/online modes.",
      },
    },
  },
  argTypes: {
    data: {
      description:
        "Complete resume data object containing basics, work, education, skills, and patents",
      control: { type: "object" },
    },
    config: {
      description:
        "Configuration options for display mode and company filtering",
      control: { type: "object" },
    },
  },
};
...
export const PrintMode = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Print-optimized version of the resume that fits on one page with condensed spacing and font sizes. Limited to 3 most recent work experiences to ensure single page layout.",
      },
    },
  },
};
...
export const LimitedWorkHistory = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Shows only the 2 most recent work experiences for a concise resume.",
      },
    },
  },
};
...
export const AllWorkExperience = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Shows all work experience without any filtering by visibility or limits.",
      },
    },
  },
};
...
export const SingleColumnPrint = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Single-column layout optimized for PDF printing. Skills, education, and patents are arranged in a single column with education in two columns.",
      },
    },
  },
};
...
export const SingleColumnOnline = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Single-column layout for online viewing with all work experience visible.",
      },
    },
  },
};
