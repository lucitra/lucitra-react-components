...
const ResumeBuilder = ({ 
  ...
  const exportResume = useCallback((format) => {
    if (format === 'json') {
          ...
          <div className="builder-header">
            ...
            <div className="builder-controls">
              <div className="control-group">
                <button 
                  className={`btn toggle-btn ${config.printMode ? 'active' : ''}`}
                  onClick={() => handleConfigChange({ printMode: !config.printMode })}
                >
              ...
              <div className="control-group">
                ...
                <select 
                  ...
                  onChange={(e) => handleConfigChange({ 
                    maxWorkItems: e.target.value ? parseInt(e.target.value) : null 
                  })}
                >
          ...
          {activeTab === 'preview' ? (
            ...
            <div className="editor-grid">
              <div className="editor-panel">
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="label">Job Title</label>
                  <input
                    id="label"
                    className="form-control"
                    type="text"
                    ...
                    placeholder="Senior Software Engineer | Applied AI Specialist"
                  />
                </div>
                ...
                <p style={{ fontSize: '14px', color: '#6c757d', marginBottom: '16px' }}>
                  {resumeData.work.length} work experience{resumeData.work.length !== 1 ? 's' : ''} added
                </p>
